...
List<TotalData> totalDataFromJson(String str) => List<TotalData>.from(json.decode(str).map((x) => TotalData.fromJson(x)));

String totalDataToJson(List<TotalData> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
